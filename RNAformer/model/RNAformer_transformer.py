...
from RNAformer.model.mini_transformer import ShallowEncoder
...
class RiboFormer(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.seq2mat_embed = ShallowEncoder(40, config.model_dim, 4, 2, config.model_dim)
    ...
    def forward(self, src_seq, src_len, pdb_sample, max_cycle=0):
        ...
        # print(logits.shape, "logits shape check.....")
